...
export default function AddTaskPopover({ isOpen, onClose, onSave, defaultDate, parentId }: Props) {
    ...
    return (
        <>
            ...
            {/* Popover */}
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-md z-50">
